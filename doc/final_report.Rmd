...
**We notice that some presidents give speeches of very different length in their several terms. Do they change their writing style during terms? Let's do more researches on how they use words.**
...
legend('topright', legend = levels(WilliamMcKinley.df$P.T),
           title = 'President Term', pch = 16, col = 5:6,cex = 0.45)
```
**It's clear that Abraham Lincoln's speech length changes much while George Washington's words using style changes much.**
\
